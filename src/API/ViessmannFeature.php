...
final class ViessmannFeature
{
    ...
    const HEATING_CIRCUITS_0_OPERATING_PROGRAMS_NODEMANDBYZERO = "heating.circuits.N.operating.programs.noDemandByZone";
    ...
    const HEATING_CIRCUITS_0_OPERATING_PROGRAMS_SUMMERECO = "heating.circuits.N.operating.programs.summerEco";
